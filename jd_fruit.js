...
function readShareCode() {
  return new Promise(async resolve => {
    $.get({url: `http://www.helpu.cf/jdcodes/getcode.php?type=farm&num=5`, timeout: 10000,}, (err, resp, data) => {
      try {
        if (err) {
          console.log(`${JSON.stringify(err)}`)
...
function shareCodesFormat() {
  return new Promise(async resolve => {
    ...
    if (readShareCodeRes && readShareCodeRes.code === 200) {
      ...
      let selfCodes = ['3be5b43ef6b34e5790c8e15eea592c08', 'bb95832c52c74422b86bfc123b03460a', 'e315ea4c1a0c4685b1f990e33b1c31be', 'fac63acf7184407b92771caa98ec51c9'];
      console.log(`随机取个${readShareCodeRes.data.length}码放到您固定的互助码后面(不影响已设置互助)`)
      newShareCodes = [...new Set([...selfCodes, ...newShareCodes, ...(readShareCodeRes.data || [])])];
    }
